...
public final class DashboardController {
    ...
    private VBox buildAuctionCard(AuctionView auction, int index) {
        ...
        Label titleLabel = new Label(safeValue(auction.item().name(), "Auction item"));
        ...
        Label priceLabel = new Label(formatPrice(auction.item().currentPrice()));
        ...
        Label typeLabel = new Label(safeValue(auction.item().itemType(), ""));
    ...
    private String resolveItemIcon(AuctionView auction) {
        String name = safeValue(auction.item().name(), "").toLowerCase(Locale.ROOT);
        ...
        if ("art".equalsIgnoreCase(safeValue(auction.item().itemType(), ""))) {
            return "🎨";
        }
        return "📦";
    }
